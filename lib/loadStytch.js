...
In this example, we use the Backend SDK in getServerSideProps for the protected page /account which can only be viewed if the user has an active Stytch session.
*/
const loadStytch = () => {
  if (!client) {
